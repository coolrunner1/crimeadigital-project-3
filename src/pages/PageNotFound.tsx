...
export const PageNotFound = () => {
    ...
    return (
        <div className="w-full px-16 md:px-0 h-screen flex items-center justify-center backdrop-blur-xl">
            <div
                ...
                <p className="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider mt-4">Page Not
                    Found</p>
                <p className="text-white mt-4 pb-4 border-b-2 text-center">Sorry, the page you are looking for
